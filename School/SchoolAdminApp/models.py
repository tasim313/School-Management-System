...
class SchoolAdminImage(UniversalModel):
    school_admin_info = models.ForeignKey(
        SchoolAdmin,
        on_delete=models.DO_NOTHING,
        related_name='school_admin_information'
    )
...
class Career(UniversalModel):
    school_career = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
        related_name='school_job_circular'
    )
    career_department = models.ForeignKey(
        Department,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
...
class EmployeeCandidate(UniversalModel):
    school_candidate = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
    ...
    phone_number = PhoneNumberField(blank=True, null=True, db_index=True, verbose_name="Phone Number")
...
class Library(UniversalModel):
    school_library = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
        related_name='school_libraries'
    )
    library_department = models.ForeignKey(
        Department,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
...
class Transport(UniversalModel):
    school_transport = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class Hostel(UniversalModel):
    school_hostel = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class SportsInformation(UniversalModel):
    school_sports = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class ClassTimeTable(UniversalModel):
    school_class_time_table = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
        related_name='school_class_time_table'
    )
    school_time_table = models.ForeignKey(
        SchoolClass,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
        related_name='school_class_information'
    )
    school_section_time_table = models.ForeignKey(
        SchoolSection,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
    ...
    class_time_table_subject = models.ForeignKey(
        Subject,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
...
class Exam(UniversalModel):
    ...
    exam_section = models.ForeignKey(
        SchoolSection,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
...
class Vendor(UniversalModel):
    school_vendor = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class ProductCategory(UniversalModel):
    school_product_category = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class PurchaseRequest(UniversalModel):
    school_purchase_request = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class PurchaseReceived(UniversalModel):
    school_purchase_received = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class GradingConfig(UniversalModel):
    school_grading = models.OneToOneField(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class Result(UniversalModel):
    school_result = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
    ...
    result_section = models.ForeignKey(
        SchoolSection,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
    ...
    result_subject = models.ForeignKey(
        Subject,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
        related_name='result_subject'
    )
    result_student = models.ForeignKey(
        Student,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
    ...
    def average_marks_for_student(self, student):
        total_marks = Result.objects.filter(result_student=student).aggregate(total_marks=Sum('mark'))[
                          'total_marks'] or 0
    ...
    def average_marks_for_subject(self, subject):
        total_marks = Result.objects.filter(result_subject=subject).aggregate(total_marks=Sum('mark'))[
                          'total_marks'] or 0
    ...
    def average_marks_for_class(self, school_class):
        total_marks = Result.objects.filter(result_class=school_class).aggregate(total_marks=Sum('mark'))[
                          'total_marks'] or 0
    ...
    def average_marks_for_section(self, section):
        total_marks = Result.objects.filter(result_section=section).aggregate(total_marks=Sum('mark'))[
                          'total_marks'] or 0
...
class HolidayManagement(UniversalModel):
    school_holiday = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
...
class FeesInformation(UniversalModel):
    fees_category = models.ForeignKey(
        FeesCategory,
        on_delete=models.DO_NOTHING,
        related_name='school_fees_category'
    )
    fess_class = models.ForeignKey(
        SchoolClass,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
        related_name='fess_classes'
    )
    fess_section = models.ForeignKey(
        SchoolSection,
        on_delete=models.DO_NOTHING,
        blank=True, null=True,
...
class FeesCollection(UniversalModel):
    school_fees_collection = models.ForeignKey(
        SchoolInformationOnBoarding,
        on_delete=models.DO_NOTHING,
        related_name='school_fees_collection'
    )
    student_fees_collection = models.ForeignKey(
        Student, on_delete=models.DO_NOTHING,
        blank=True, null=True,
        related_name='fees_collection_students'
    )
    fees_collection_category = models.ForeignKey(
        FeesCategory,
        on_delete=models.DO_NOTHING,
