...
class Student(UniversalModel):
    school_student = models.ForeignKey(SchoolInformationOnBoarding, on_delete=models.DO_NOTHING, related_name='student_school_information')
    student_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='user_student_info')
    ...
    slug = AutoSlugField(populate_from=get_school_student_slug, unique=True, null=False, db_index=True)
    student_name_bangla = models.CharField(max_length=255, blank=True, null=True)
    student_name_english_captial = models.CharField(max_length=255, blank=True, null=True)
    birth_certificate_number = models.CharField(max_length=255, blank=True, null=True)
    birth_of_place = models.CharField(max_length=255, blank=True, null=True, verbose_name='Owen district as follow birth_certificate')
...
class StudentImage(UniversalModel):
    student_info = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_information')
    slug = AutoSlugField(populate_from=get_school_student_image_slug, unique=True, null=False, db_index=True)
    image = VersatileImageField(upload_to=get_student_profile_image, null=True, blank=True)


class StudentCurrentStatus(UniversalModel):
    student_current_status = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_current_status_information')
    current_class = models.ForeignKey(SchoolClass, on_delete=models.SET_NULL, null=True, blank=True, related_name='student_current_class')
    current_section = models.ForeignKey(SchoolSection, on_delete=models.SET_NULL, null=True, blank=True, related_name='student_current_section')
    slug = AutoSlugField(populate_from=get_school_student_current_slug, unique=True, null=False, db_index=True)
    class_roll_number = models.CharField(max_length=100, blank=True, null=True)


class StudentPermanentAddress(UniversalModel):
    student_permanent_address = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_permanent_address_information')
    slug = AutoSlugField(populate_from=get_student_permanent_address_slug, unique=True, null=False, db_index=True)
...
class StudentPresentAddress(UniversalModel):
    student_present_address = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_present_address_information')
    slug = AutoSlugField(populate_from=get_student_present_address_slug, unique=True, null=False, db_index=True)
    divisions = models.CharField(max_length=255, blank=True, null=True)
    district  = models.CharField(max_length=255, blank=True, null=True)
    upazila  = models.CharField(max_length=255, blank=True, null=True, verbose_name='Upozila or Thana')
    pourashava = models.CharField(max_length=255, blank=True, null=True, verbose_name='Pourashava or City Corporation')
...
class StudentFather(UniversalModel):
    student_father = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_father_information')
...
class StudentMother(UniversalModel):
    student_mother = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name='student_mother_information')
    name_bangla = models.CharField(max_length=255, blank=True, null=True)
    name_english_capital = models.CharField(max_length=255, blank=True, null=True)
    nid = models.CharField(max_length=255, blank=True, null=True)
    date_of_birth = models.DateField(blank=True, null=True)
...
# class StudentProfile(UniversalModel):
#     student_profile = models.ForeignKey(Student, on_delete=models.DO_NOTHING, related_name="student_profile_information")
#     about = models.TextField(max_length=555, blank=True, null=True)
#     profile_pic = VersatileImageField(upload_to=get_student_profile_image_optional, null=True, blank=True)
#     cover_pic = VersatileImageField(upload_to=get_student_cover_image_optional, null=True, blank=True)
#     slug = AutoSlugField(populate_from=get_student_profile_slug, unique=True, null=False, db_index=True)